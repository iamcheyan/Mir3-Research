...
| 屏幕基准 | **800×600** | `GUIFScreenWidth=800` 是**残留默认值**，实际根窗体 1095×975 |
...
**Preview 版与原版 EI 3.0 是同引擎的不同构建，四类关键资产全部不通用**：

| 资产 | 原版 | Preview | 可互推？ |
|---|---|---|---|
| **帧号空间** | `GameInter` 1103 帧（0–1102） | 引用 184–1960（91 个唯一帧号） | ❌ 交集 10 个且与已详查帧零重合 |
| **窗口尺寸** | 800×600 基准 | 1024×768+ 布局 | ❌ 背包 284×324 vs 111×144 等，无一组吻合 |
