...
> ⚠️ **2026-08-12 v2 更正**：以上"当前 EI 数据"（法师=潘夜村／道士=失乐园）经与 mir3-website missions.json
> 官方任务数据核对有误——**官方出生地为：战士=新手村（比奇）·接引上官小姐、法师=银杏村·接引南宫小姐、
> 道士=白日门·道观·接引士官**。任务设计文档（quest-design 01-07）已按官方数据全面修正；
> 本表出生地一列应以官方为准，失乐园仅保留为神舰入口等剧情地点（非道士出生点）。
...
- [x] 核对职业出生点具体地图（已确认：战士=新手村比奇 / 法师=银杏村 / 道士=白日门·道观，数据源 mir3-website missions.json 官方任务；EI SafeZoneInfo.StartClass 的"潘夜村/失乐园"为旧数据，已弃用）
