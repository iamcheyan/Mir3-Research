...
type
  ...
  public
   ...
   TResDownGList = class(TStringList)
  private
...
implementation
{ TResDownGList }
constructor TResDownGList.Create;
begin
  inherited Create;
  InitializeCriticalSection(GLock);
end;

destructor TResDownGList.Destroy;
begin
  DeleteCriticalSection(GLock);
  inherited;
end;

procedure TResDownGList.Lock;
begin
  EnterCriticalSection(GLock);
end;

procedure TResDownGList.UnLock;
begin
