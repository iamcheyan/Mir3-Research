...
/*
	...
	Date:
		2001/02/05 (Last Updated: 2002/04/17)

	Note: 
		양방향 연결 리스트

	History:
		2002/04/17: Swap() 함수 추가됨
*/
...
template< class T >
void CList< T >::Swap( CList< T > *pList )
{
	CListNode< T > *pNode;
	...
	m_nCount ^= pList->m_nCount ^= m_nCount ^= pList->m_nCount;
}
