...
uses
  ...
  wmM3Def, wmMyImage, ShellAPI, Clipbrd, StdCtrls, Buttons, mpalett, Menus,
  ExtCtrls, HUtil32, WIL, DES;
...
type
  ...
  public
    MArr: array[0..MAXX + 10, 0..MAXY + 10] of TTileInfo;
    MArrOb: array[0..MAXX + 10, 0..MAXY + 10] of TCellInfo;
...
var
  FrmMain: TFrmMain;
  BaseDir: string;
  WilArr: array[0..69] of TWMImages;
//  WilCount: Integer;
implementation
...
var
  I: integer;
begin
  WilArr[0].FileName := 'Data\tilesc.Lib';
  WilArr[1].FileName := 'Data\tiles30c.Lib';
  WilArr[2].FileName := 'Data\Tiles5c.Lib';
  WilArr[3].FileName := 'Data\smtilesc.Lib';	
  WilArr[4].FileName := 'Data\housesc.Lib';
  WilArr[5].FileName := 'Data\cliffsc.Lib';
  WilArr[6].FileName := 'Data\dungeonsc.Lib';
  WilArr[7].FileName := 'Data\innersc.Lib';
  WilArr[8].FileName := 'Data\furnituresc.Lib';
  WilArr[9].FileName := 'Data\wallsc.Lib';	
  WilArr[10].FileName := 'Data\smobjectsc.Lib';
  WilArr[11].FileName := 'Data\animationsc.Lib';
  WilArr[12].FileName := 'Data\object1c.Lib';
  WilArr[13].FileName := 'Data\object2c.Lib';
  WilArr[14].FileName := 'Data\Wood\tilesc.Lib';
  WilArr[15].FileName := 'Data\Wood\tiles30c.Lib';
  WilArr[16].FileName := 'Data\Wood\Tiles5c.Lib';
  WilArr[17].FileName := 'Data\Wood\smtilesc.Lib';
  WilArr[18].FileName := 'Data\Wood\housesc.Lib';
  WilArr[19].FileName := 'Data\Wood\cliffsc.Lib';
  WilArr[20].FileName := 'Data\Wood\dungeonsc.Lib';
  WilArr[21].FileName := 'Data\Wood\innersc.Lib';
  WilArr[22].FileName := 'Data\Wood\furnituresc.Lib';
  WilArr[23].FileName := 'Data\Wood\wallsc.Lib';
  WilArr[24].FileName := 'Data\Wood\smobjectsc.Lib';
  WilArr[25].FileName := 'Data\Wood\animationsc.Lib';
  WilArr[26].FileName := 'Data\Wood\object1c.Lib';
  WilArr[27].FileName := 'Data\Wood\object2c.Lib';
  WilArr[28].FileName := 'Data\Sand\tilesc.Lib';
  WilArr[29].FileName := 'Data\Sand\tiles30c.Lib';
  WilArr[30].FileName := 'Data\Sand\Tiles5c.Lib';
  WilArr[31].FileName := 'Data\Sand\smtilesc.Lib';
  WilArr[32].FileName := 'Data\Sand\housesc.Lib';
  WilArr[33].FileName := 'Data\Sand\cliffsc.Lib';
  WilArr[34].FileName := 'Data\Sand\dungeonsc.Lib';
  WilArr[35].FileName := 'Data\Sand\innersc.Lib';
  WilArr[36].FileName := 'Data\Sand\furnituresc.Lib';
  WilArr[37].FileName := 'Data\Sand\wallsc.Lib';
  WilArr[38].FileName := 'Data\Sand\smobjectsc.Lib';
  WilArr[39].FileName := 'Data\Sand\animationsc.Lib';
  WilArr[40].FileName := 'Data\Sand\object1c.Lib';
  WilArr[41].FileName := 'Data\Sand\object2c.Lib';
  WilArr[42].FileName := 'Data\Snow\tilesc.Lib';
  WilArr[43].FileName := 'Data\Snow\tiles30c.Lib';
  WilArr[44].FileName := 'Data\Snow\Tiles5c.Lib';
  WilArr[45].FileName := 'Data\Snow\smtilesc.Lib';
  WilArr[46].FileName := 'Data\Snow\housesc.Lib';
  WilArr[47].FileName := 'Data\Snow\cliffsc.Lib';
  WilArr[48].FileName := 'Data\Snow\dungeonsc.Lib';
  WilArr[49].FileName := 'Data\Snow\innersc.Lib';
  WilArr[50].FileName := 'Data\Snow\furnituresc.Lib';
  WilArr[51].FileName := 'Data\Snow\wallsc.Lib';
  WilArr[52].FileName := 'Data\Snow\smobjectsc.Lib';
  WilArr[53].FileName := 'Data\Snow\animationsc.Lib';
  WilArr[54].FileName := 'Data\Snow\object1c.Lib';
  WilArr[55].FileName := 'Data\Snow\object2c.Lib';
  WilArr[56].FileName := 'Data\Forest\tilesc.Lib';
  WilArr[57].FileName := 'Data\Forest\tiles30c.Lib';
  WilArr[58].FileName := 'Data\Forest\Tiles5c.Lib';
  WilArr[59].FileName := 'Data\Forest\smtilesc.Lib';
  WilArr[60].FileName := 'Data\Forest\housesc.Lib';
  WilArr[61].FileName := 'Data\Forest\cliffsc.Lib';
  WilArr[62].FileName := 'Data\Forest\dungeonsc.Lib';
  WilArr[63].FileName := 'Data\Forest\innersc.Lib';
  WilArr[64].FileName := 'Data\Forest\furnituresc.Lib';
  WilArr[65].FileName := 'Data\Forest\wallsc.Lib';
  WilArr[66].FileName := 'Data\Forest\smobjectsc.Lib';
  WilArr[67].FileName := 'Data\Forest\animationsc.Lib';
  WilArr[68].FileName := 'Data\Forest\object1c.Lib';
  WilArr[69].FileName := 'Data\Forest\object2c.Lib';

  for I := Low(WilArr) to High(WilArr) do begin
    WilArr[I].LibType := ltLoadBmp;
    InitializeImage(WilArr[I]);
  end;
end;
...
begin
  ...
  for I := Low(WilArr) to High(WilArr) do begin
    WilArr[I] := CreateWMImages(t_wmMyImage);
  end;
  InitWMImagesLib;
