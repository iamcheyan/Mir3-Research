...
{$IFDEF WORKFILE}
    ...
    function CopyDataToTexture(index: integer; Texture: TDirectDrawSurface): Boolean; override;
...
function TWMM2DefImages.CopyDataToTexture(index: integer; Texture: TDirectDrawSurface): Boolean;
var
  nPosition: Integer;
  imginfo: TWMImageInfo;
  Buffer: PChar;
...
function TWMM2DefImages.CopyImageDataToTexture(Buffer: PChar; Texture: TDirectDrawSurface; Width, Height: Word): Boolean;
var
  Y: Integer;
