...
begin
  ...
  if Assigned(FOnDirectPaint) then
    ...
    if d <> nil then begin
      with g_DXCanvas do begin
        if Checked then
          TextOutEx(SurfaceX(Left) + d.Width + FFontSpace + FOffsetLeft,
    ...
    for i := FTopIndex to (FTopIndex + nShowCount - 1) do begin
      ...
      if nStartY <> nStopY then begin
        if i = nStartY then begin
          ...
          TextOutEx(ax, ay + (i - FTopIndex) * 14, TempStr, FDFColor);
          ...
          TextOutEx(ax + addax, ay + (i - FTopIndex) * 14, TempStr, FDFColor);
          //Release;
          //SetBkMode(Handle, TRANSPARENT);
        end
          ...
          TextOutEx(ax, ay + (i - FTopIndex) * 14, Lines[i], FDFColor);
          //Release;
          //SetBkMode(Handle, TRANSPARENT);
        end
        else
